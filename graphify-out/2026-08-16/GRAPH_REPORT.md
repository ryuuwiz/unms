...
## Corpus Check
- 328 files · ~141,679 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1940 nodes · 2247 edges · 209 communities (190 shown, 19 thin omitted)
...
1. `User` - 50 edges
2. `Customer` - 45 edges
3. `AuditLogger` - 27 edges
4. `AuditLog` - 24 edges
5. `RolesAndPermissionsSeeder` - 13 edges
6. `scripts` - 13 edges
7. `PRD #2: Customer Management` - 12 edges
8. `PRD #3: Package Management` - 12 edges
9. `PRD #0: Dashboard Shell & UI Foundation` - 12 edges
10. `PRD #1: Users & Roles Management` - 12 edges
...
- `Customer` --inherits--> `Illuminate\Database\Eloquent\Model`  [EXTRACTED]
  app/Models/Customer.php →   _Bridges community 1 → community 23_
...
- `Profile` --inherits--> `Livewire\Component`  [EXTRACTED]
  app/Livewire/Settings/Profile.php →   _Bridges community 0 → community 2_
...
Cohesion: 0.17
Nodes (15): Index, Appearance, DeleteUserForm, Create, App\Livewire\Users\Index, Index, Flux\Flux, Illuminate\Support\Collection (+7 more)

### Community 1 - "Customer"
Cohesion: 0.08
Nodes (10): Edit, Index, Show, Customer, Illuminate\Database\Eloquent\Attributes\Fillable, Illuminate\Database\Eloquent\Builder, Illuminate\Database\Eloquent\Collection, Illuminate\Database\Eloquent\Factories\HasFactory (+2 more)

### Community 2 - "User"
Cohesion: 0.09
Nodes (7): Profile, Edit, UsersList, User, Illuminate\Foundation\Auth\User, Illuminate\Support\Facades\Hash, Illuminate\Validation\ValidationException
...
Cohesion: 0.12
Nodes (5): Create, Create, Edit, Role, Illuminate\View\View
...
Cohesion: 0.13
Nodes (9): AuditLog, AuditLogger, User, Illuminate\Database\Eloquent\Model, Illuminate\Database\Eloquent\Relations\BelongsTo, Illuminate\Support\Facades\Request, Role, Spatie\Permission\DefaultTeamResolver (+1 more)
...
Cohesion: 0.14
Nodes (6): CustomerFactory, UserFactory, Illuminate\Database\Eloquent\Factories\Factory, Illuminate\Support\Str, Pdo\Mysql, static
...
Cohesion: 0.16
Nodes (7): App\Livewire\Customers, App\Livewire\Roles, Security, App\Livewire\Users, Illuminate\Support\Facades\Route, Laravel\Fortify\Actions\DisableTwoFactorAuthentication, Laravel\Passkeys\Actions\DeletePasskey
...
### Community 100 - "CustomerStatus.php"
Cohesion: 0.22
...
### Community 205 - "App\Models\User"
Cohesion: 0.23
Nodes (7): App\Models\User, CustomerPolicy, Illuminate\Database\Eloquent\Attributes\Hidden, Illuminate\Notifications\Notifiable, Laravel\Fortify\Contracts\PasskeyUser, Laravel\Fortify\PasskeyAuthenticatable, Spatie\Permission\Traits\HasRoles
...
## Knowledge Gaps
- **1032 isolated node(s):** `Language`, `Context`, `Decisions`, `1. Ringkasan`, `2. Tujuan` (+1027 more)
...
- **Why does `User` connect `User` to `Livewire\Component`, `Customer`, `Illuminate\Support\Str`, `PasswordValidationRules.php`, `Illuminate\View\View`, `Laravel\Fortify\Features`, `App\Models\User`, `AuditLogger`, `App\Enums\UserStatus`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `Customer` connect `Customer` to `Livewire\Component`, `Illuminate\Support\Str`, `CustomerStatus.php`, `Illuminate\View\View`, `App\Models\User`, `AuditLogger`, `App\Enums\UserStatus`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `Profile` connect `User` to `Livewire\Component`, `Security`, `PasswordValidationRules.php`?**
