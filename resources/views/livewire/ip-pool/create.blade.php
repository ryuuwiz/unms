<div class="mx-auto max-w-2xl space-y-6">
    <div>
        ...
        <flux:subheading>Definisikan rentang subnet IP untuk dialokasikan ke pelanggan.</flux:subheading>
    </div>
    ...
    <form wire:submit="save" class="space-y-6">
        <flux:field>
            ...
            <flux:input wire:model="nama_pool" placeholder="Contoh: Pool-Rumahan-01" autofocus />
            <flux:description>Huruf, angka, strip, dan underscore saja (tanpa spasi) -- nama ini dipakai sebagai remote-address pada Profile PPP per Pool di MikroTik.</flux:description>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <flux:field class="sm:col-span-2">
                ...
                <flux:input wire:model="ip_network" placeholder="Contoh: 192.168.10.0" />
                <flux:error name="ip_network" />
            </flux:field>

            <flux:field class="sm:col-span-1">
                <flux:label>CIDR</flux:label>
                <flux:input wire:model="cidr" type="number" min="1" max="32" placeholder="24" />
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <flux:field>
                ...
                <flux:input wire:model="rentang_ip_awal" placeholder="Contoh: 192.168.10.2" />
                <flux:error name="rentang_ip_awal" />
            </flux:field>

            <flux:field>
                <flux:label>Rentang IP Akhir</flux:label>
                <flux:input wire:model="rentang_ip_akhir" placeholder="Contoh: 192.168.10.254" />
        ...
        <div class="flex items-center justify-end gap-3 pt-2">
            ...
            <flux:button type="submit" variant="primary" icon="check">Simpan IP Pool</flux:button>
        </div>
    </form>
</div>
