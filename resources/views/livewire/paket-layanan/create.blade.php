<div class="mx-auto max-w-2xl space-y-6">
    <div>
        <flux:heading size="xl">Tambah Paket Layanan</flux:heading>
        <flux:subheading>Buat paket internet baru dan hubungkan dengan profil bandwidth RouterOS.</flux:subheading>
    </div>
    ...
    <form wire:submit="save" class="space-y-6">
        <flux:field>
            ...
            <flux:input wire:model="nama_paket" placeholder="Contoh: Paket Home 20 Mbps" autofocus />
