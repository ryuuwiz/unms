<div class="mx-auto max-w-3xl space-y-6">
    <div>
        <flux:heading size="xl">Edit Data ODP</flux:heading>
        <flux:subheading>Perbarui konfigurasi titik ODP, kapasitas port, dan koordinat lokasi pemasangan.</flux:subheading>
    </div>
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <flux:field>
                    ...
                    <flux:input wire:model="nama_odp" placeholder="Contoh: ODP-MLT-01" />
                ...
                <flux:field>
                    ...
                    <flux:description>Port berlebih akan disesuaikan secara aman jika tidak terpakai.</flux:description>
