<div class="mx-auto max-w-2xl space-y-6">
    <div>
        <flux:heading size="xl">Edit Profil Bandwidth</flux:heading>
        <flux:subheading>Perbarui konfigurasi profil bandwidth {{ $nama_bandwidth }}.</flux:subheading>
    </div>
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="flex items-center justify-end gap-3 pt-2">
            ...
            <flux:button type="submit" variant="primary" icon="check">Perbarui Profil</flux:button>
        </div>
    </form>
</div>
