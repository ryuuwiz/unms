<div class="max-w-3xl mx-auto space-y-6">
    <div>
        ...
        <flux:subheading>Perbarui konfigurasi IP Pool.</flux:subheading>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        <flux:field class="flex-1">
                            <flux:input wire:model="ip_range_start" placeholder="IP Awal" />
                            <flux:error name="ip_range_start" />
                        </flux:field>
                        <span class="text-zinc-400 font-medium mt-1">-</span>
                        <flux:field class="flex-1">
                            <flux:input wire:model="ip_range_end" placeholder="IP Akhir" />
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <flux:field>
                        ...
                        <flux:input type="number" step="0.01" wire:model="queue_tx_mbps" />
                        <flux:error name="queue_tx_mbps" />
                    </flux:field>

                    <flux:field>
                        <flux:label>Queue Limit RX (Mbps)</flux:label>
                        <flux:input type="number" step="0.01" wire:model="queue_rx_mbps" />
