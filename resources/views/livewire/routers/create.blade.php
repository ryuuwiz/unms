<div class="max-w-2xl mx-auto space-y-6">
    <div>
        ...
        <flux:subheading>Masukkan informasi dasar untuk router baru.</flux:subheading>
    </div>
    ...
    <form wire:submit="save" class="space-y-6">
                ...
                @role('super_admin')
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <flux:field>
                            ...
                            <flux:description>Opsional. Kosongkan jika menggunakan metode autentikasi lain.
                            </flux:description>
        ...
        <div class="flex items-center justify-end gap-3">
            ...
            <flux:button type="submit" variant="primary">Simpan Router</flux:button>
        </div>
    </form>
</div>
