<div class="mx-auto max-w-2xl space-y-6">
    <div>
        <flux:heading size="xl">Tambah Kota</flux:heading>
        <flux:subheading>Daftarkan kota atau kabupaten baru ke dalam sistem cakupan wilayah.</flux:subheading>
    </div>
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="flex items-center justify-end gap-3 pt-2">
            ...
            <flux:button type="submit" variant="primary" icon="check">Simpan Kota</flux:button>
        </div>
    </form>
</div>
