<div class="mx-auto max-w-2xl space-y-6">
    <div>
        <flux:heading size="xl">Tambah Kelurahan</flux:heading>
        <flux:subheading>Daftarkan kelurahan atau desa baru dengan memilih hierarki kota dan kecamatan.</flux:subheading>
    </div>
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="flex items-center justify-end gap-3 pt-2">
            ...
            <flux:button type="submit" variant="primary" icon="check">Simpan Kelurahan</flux:button>
        </div>
    </form>
</div>
