<div class="mx-auto max-w-2xl space-y-6">
    <div>
        ...
        <flux:subheading>Daftarkan kecamatan baru di bawah kota/kabupaten yang ditentukan.</flux:subheading>
    </div>
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="flex items-center justify-end gap-3 pt-2">
            ...
            <flux:button type="submit" variant="primary" icon="check">Simpan Kecamatan</flux:button>
        </div>
    </form>
</div>
