<div class="mx-auto max-w-3xl space-y-6">
    <div>
        <flux:heading size="xl">Edit Perumahan / Cluster</flux:heading>
        <flux:subheading>Perbarui informasi perumahan, kode singkatan, hierarki wilayah, atau titik koordinat.</flux:subheading>
    </div>
