<div class="mx-auto max-w-3xl space-y-6">
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <div class="flex items-center gap-3">
                ...
                <flux:badge size="sm" color="zinc" class="font-mono">{{ $customer_code }}</flux:badge>
            </div>
            <flux:subheading>Perbarui data identitas, kontak, atau titik lokasi instalasi pelanggan.</flux:subheading>
        </div>
        ...
        <div class="flex items-center gap-2">
            ...
            >
                {{ $status === 'active' ? 'Nonaktifkan Pelanggan' : 'Aktifkan Pelanggan' }}
            </flux:button>
        </div>
    </div>
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <flux:field>
                    ...
                    <flux:input value="{{ $customer_code }}" disabled class="bg-zinc-100 dark:bg-zinc-800 font-mono" />
                    <flux:description>Kode pelanggan bersifat permanen dan tidak dapat diubah.</flux:description>
                </flux:field>

                <flux:field>
                    <flux:label>Nama Lengkap</flux:label>
                    <flux:input wire:model="name" placeholder="Contoh: Budi Santoso" />
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <flux:field>
                    ...
                    <flux:input wire:model="phone" type="tel" placeholder="08123456789" />
                    <flux:description>Format nomor telepon Indonesia (08... atau +628...).</flux:description>
        ...
        <div class="space-y-4">
            ...
            <div class="space-y-2">
                <flux:label>Peta Titik Koordinat Instalasi</flux:label>
